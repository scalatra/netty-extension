...
import static org.jboss.netty.handler.codec.http2bak.HttpCodecUtil.COLON;
import static org.jboss.netty.handler.codec.http2bak.HttpCodecUtil.CRLF;
import static org.jboss.netty.handler.codec.http2bak.HttpCodecUtil.SP;
...
public abstract class HttpMessageEncoder extends OneToOneEncoder {
    ...
    protected Object encode(ChannelHandlerContext ctx, Channel channel,
        ...
        if (msg instanceof HttpMessage) {
            ...
            ChannelBuffer header = ChannelBuffers.dynamicBuffer(channel
        ...
        if (msg instanceof HttpChunk) {
            ...
            if (chunk.isLast()) {
                ...
                return wrappedBuffer(copiedBuffer(Integer
                        .toHexString(contentLength), "ASCII"),
                        wrappedBuffer(CRLF), content.slice(content
