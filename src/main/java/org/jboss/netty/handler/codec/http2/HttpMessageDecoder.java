 ...
 * @apiviz.landmark
 */
public abstract class HttpMessageDecoder extends
        ReplayingDecoder<HttpMessageDecoder.State> {
     ...
     */
    protected HttpMessageDecoder(int maxInitialLineLength, int maxHeaderSize,
            int maxChunkSize) {
    ...
    private String readHeader(ChannelBuffer buffer)
            throws TooLongFrameException {
