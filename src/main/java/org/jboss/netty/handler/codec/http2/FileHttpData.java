...
/**
 * File interface for HttpData
 * @author frederic bregier
 *
 */
public interface FileHttpData extends HttpData {
    /**
    ...
    /**
     *
     * @return True if the HttpData is completed (all data are stored)
     */
    public boolean isCompleted();

    /**
     * Returns the size in byte of the HttpData
     * @return the size of the HttpData
     */
    public long length();
     ...
     * of the factory that creates the original HttpData object.
